...
print("WELCOME DEAR USER, TODAY WE WILL TRY TO LOOK DEEP INTO YOUR MINDS:")
print("THINK OF A WORD WITH THE STARTING LETTER AS A. I HAVE 3 CHANCES, I SHALL PROVE TO YOU MY TELEPATHIC ABILITIES.")
print("THEN, GIVE THE FIRST 2 - 3 LETTERS OF THE WORD.")

for i in range(0, 3):
    data = str(input("ENTER FIRST LETTERS: "))
    print(predict_string(data))
    ask = input("WAS I CORRECT?(y for yes, rest: next try)")
    if ask == "y":
        print("THANK YOU")
        quit()

print("OH WOW! MAY I ASK WHAT WAS THE WORD?")
word_which = input(": ")
common_words.insert(1, str(word_which))
